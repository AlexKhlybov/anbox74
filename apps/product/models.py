...
class Boiler(Product):
    ...
    without_measure = models.CharField(max_length=255, null=True, blank=True, verbose_name='Габаритные размеры, мм (без патрубком)')
    with_measure = models.CharField(max_length=255, null=True, blank=True, verbose_name='Габаритные размеры, мм (c патрубком)')
